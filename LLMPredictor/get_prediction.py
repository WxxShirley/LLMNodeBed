...
from common import API_KEYS, GPT4_RESOURCE, GPT4o_MINI_RESOURCE
...
class prediction:
    ...
    def prompt(self):
        ...
        if self.prediction_type == "none":
            ...
            summary_prediction = prediction("summary", self.dataset, self.model_name, self.index, self.write_file_path,
                                            self.graph_data)
            summary = summary_prediction.get_response()[:100]
    ...
    def get_response(self):
        ...
        elif self.model_name == "gpt-4" or self.model_name == "gpt-4o-mini":
            if self.model_name == "gpt-4o-mini":
                current_llm = GPT4o_MINI_RESOURCE
            else:
