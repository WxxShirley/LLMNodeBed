...
if __name__ == "__main__":
    ...
    for test_node in test_node_ids: 
        origin_txt = graph_data.raw_texts[test_node][:2048]
        ...
        try: 
            output = model.generate(input_ids, max_length=32, temperature=0.9)
        ...
        write_content = {
            ...
            "ground-truth": classes[args.dataset][graph_data.y[test_node].item()], 
            "pred": decode_output 
        }
        pred_labels.append(pred_label) 
        gt_labels.append(write_content["ground-truth"])
